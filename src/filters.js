...
const COUNTRIES = [
  // North America
  { code: 'US', name: 'United States', lat: 38, lng: -97, zoom: 1.8 },
  { code: 'CA', name: 'Canada', lat: 56, lng: -106, zoom: 2.0 },
  { code: 'MX', name: 'Mexico', lat: 23, lng: -102, zoom: 2.0 },

  // Europe
  { code: 'GB', name: 'United Kingdom', lat: 54, lng: -2, zoom: 1.2 },
  { code: 'DE', name: 'Germany', lat: 51, lng: 10, zoom: 1.2 },
  { code: 'FR', name: 'France', lat: 46, lng: 2, zoom: 1.2 },
  { code: 'ES', name: 'Spain', lat: 40, lng: -4, zoom: 1.2 },
  { code: 'IT', name: 'Italy', lat: 42, lng: 12, zoom: 1.2 },
  { code: 'NL', name: 'Netherlands', lat: 52, lng: 5, zoom: 0.8 },
  { code: 'CH', name: 'Switzerland', lat: 47, lng: 8, zoom: 0.8 },
  { code: 'AT', name: 'Austria', lat: 47, lng: 14, zoom: 0.8 },
  { code: 'BE', name: 'Belgium', lat: 50, lng: 4, zoom: 0.8 },
  { code: 'PL', name: 'Poland', lat: 52, lng: 20, zoom: 1.2 },
  { code: 'SE', name: 'Sweden', lat: 62, lng: 15, zoom: 1.5 },
  { code: 'NO', name: 'Norway', lat: 62, lng: 10, zoom: 1.5 },
  { code: 'FI', name: 'Finland', lat: 64, lng: 26, zoom: 1.5 },
  { code: 'DK', name: 'Denmark', lat: 56, lng: 10, zoom: 0.8 },
  { code: 'IE', name: 'Ireland', lat: 53, lng: -8, zoom: 1.0 },
  { code: 'PT', name: 'Portugal', lat: 39, lng: -8, zoom: 1.0 },
  { code: 'GR', name: 'Greece', lat: 39, lng: 22, zoom: 1.2 },
  { code: 'CZ', name: 'Czech Republic', lat: 50, lng: 15, zoom: 0.8 },
  { code: 'RO', name: 'Romania', lat: 46, lng: 25, zoom: 1.2 },
  { code: 'HU', name: 'Hungary', lat: 47, lng: 20, zoom: 0.8 },
  { code: 'RU', name: 'Russia', lat: 60, lng: 100, zoom: 3.0 },
  { code: 'TR', name: 'Turkey', lat: 39, lng: 35, zoom: 1.5 },

  // Middle East
  { code: 'AE', name: 'United Arab Emirates', lat: 24, lng: 54, zoom: 0.8 },
  { code: 'QA', name: 'Qatar', lat: 25, lng: 51, zoom: 0.6 },
  { code: 'SA', name: 'Saudi Arabia', lat: 24, lng: 45, zoom: 1.8 },
  { code: 'IL', name: 'Israel', lat: 31, lng: 35, zoom: 0.8 },

  // Asia
  { code: 'CN', name: 'China', lat: 35, lng: 105, zoom: 2.5 },
  { code: 'JP', name: 'Japan', lat: 36, lng: 138, zoom: 1.5 },
  { code: 'KR', name: 'South Korea', lat: 36, lng: 128, zoom: 1.0 },
  { code: 'IN', name: 'India', lat: 21, lng: 78, zoom: 2.0 },
  { code: 'SG', name: 'Singapore', lat: 1, lng: 104, zoom: 0.5 },
  { code: 'TH', name: 'Thailand', lat: 15, lng: 101, zoom: 1.5 },
  { code: 'MY', name: 'Malaysia', lat: 4, lng: 109, zoom: 1.5 },
  { code: 'ID', name: 'Indonesia', lat: -2, lng: 118, zoom: 2.5 },
  { code: 'PH', name: 'Philippines', lat: 13, lng: 122, zoom: 1.5 },
  { code: 'VN', name: 'Vietnam', lat: 16, lng: 108, zoom: 1.5 },
  { code: 'HK', name: 'Hong Kong', lat: 22, lng: 114, zoom: 0.5 },
  { code: 'TW', name: 'Taiwan', lat: 24, lng: 121, zoom: 0.8 },

  // Oceania
  { code: 'AU', name: 'Australia', lat: -25, lng: 135, zoom: 2.5 },
  { code: 'NZ', name: 'New Zealand', lat: -41, lng: 174, zoom: 1.5 },

  // South America
  { code: 'BR', name: 'Brazil', lat: -14, lng: -51, zoom: 2.5 },
  { code: 'AR', name: 'Argentina', lat: -34, lng: -64, zoom: 2.2 },
  { code: 'CL', name: 'Chile', lat: -35, lng: -71, zoom: 2.5 },
  { code: 'CO', name: 'Colombia', lat: 4, lng: -72, zoom: 1.5 },
  { code: 'PE', name: 'Peru', lat: -10, lng: -76, zoom: 1.8 },

  // Africa
  { code: 'ZA', name: 'South Africa', lat: -29, lng: 25, zoom: 1.8 },
  { code: 'EG', name: 'Egypt', lat: 27, lng: 30, zoom: 1.5 },
  { code: 'MA', name: 'Morocco', lat: 32, lng: -6, zoom: 1.2 },
  { code: 'KE', name: 'Kenya', lat: 0, lng: 38, zoom: 1.5 },
  { code: 'ET', name: 'Ethiopia', lat: 9, lng: 39, zoom: 1.5 },
  { code: 'NG', name: 'Nigeria', lat: 10, lng: 8, zoom: 1.5 },
];
...
const REGIONS = [
  { name: 'North America', lat: 40, lng: -100, zoom: 2.2, type: 'region' },
  { name: 'South America', lat: -15, lng: -60, zoom: 2.5, type: 'region' },
  { name: 'Europe', lat: 50, lng: 10, zoom: 2.0, type: 'region' },
  { name: 'Africa', lat: 5, lng: 20, zoom: 2.5, type: 'region' },
  { name: 'Asia', lat: 35, lng: 100, zoom: 2.8, type: 'region' },
  { name: 'Australia', lat: -25, lng: 135, zoom: 2.2, type: 'region' },
  { name: 'Oceania', lat: -20, lng: 150, zoom: 2.5, type: 'region' },
  { name: 'Middle East', lat: 28, lng: 45, zoom: 1.8, type: 'region' },
  { name: 'Southeast Asia', lat: 10, lng: 110, zoom: 2.2, type: 'region' },
  { name: 'Central America', lat: 15, lng: -85, zoom: 1.8, type: 'region' },
  { name: 'Caribbean', lat: 18, lng: -75, zoom: 1.5, type: 'region' },
  { name: 'Scandinavia', lat: 62, lng: 15, zoom: 2.0, type: 'region' },
];
